...
function GetRepoInformations()
    ...
    PerformHttpRequest("https://api.github.com/repos/ScubeScripts/sc_lawn/releases/latest", function(err, response)
        if err == 200 then
            ...
            repoURL = "https://github.com/ScubeScripts/sc_lawn"
        end
    end, "GET")
    repeat
        Wait(50)
...
CreateThread(function()
    if GetCurrentResourceName() ~= "sc_lawn" then
        resourceName = "sc_lawn (" .. GetCurrentResourceName() .. ")"
    end
